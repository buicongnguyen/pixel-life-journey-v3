...
> **Version 3** — builds on v2's feature set and adds a **day/night theme toggle**, a
> taller room with safe-area-aware floating controls, an **orientation-responsive wide
> landscape layout**, and a **Rambo-style analog thumb-stick** (works with touch *and*
> mouse) on top of keyboard. The earlier editions live on as their own games:
> [v1](https://buicongnguyen.github.io/pixel-life-journey/) ·
> [v2](https://buicongnguyen.github.io/pixel-life-journey-v2/).

**▶ Play it live:** https://buicongnguyen.github.io/pixel-life-journey-v3/
